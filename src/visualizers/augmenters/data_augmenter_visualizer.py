...
def visualize_mask_augmentations(augmenter, mask):
    """Visualizes a set of augmentations applied to a single mask."""
...
def visualize_random_mask_augmentations(augmenter, mask, n_samples=16):
    """Visualizes a grid of random augmentations applied to a single mask."""
    n_cols = 4
    col_scale = 2.5
...
def visualize_illumination_samplers(augmenter, sim_config, n_cols=5):
    """Visualizes a set of illumination patterns generated by different sampling strategies."""
...
def visualize_random_illumination_augmentations(augmenter, sim_config, n_samples=20, n_cols=5):
    """Visualizes a grid of random illumination patterns generated by the augmenter."""
    n_rows = int(np.ceil(n_samples / n_cols))
