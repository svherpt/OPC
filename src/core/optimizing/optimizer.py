...
def parse_args():
    ...
    parser.add_argument("--base_iterations",   type=int, default=500,   help="Continuous phase iterations")
    parser.add_argument("--binary_iterations", type=int, default=200,   help="Binary phase iterations")
